...
public class PacienteController {
    ...
    @DeleteMapping("/{id}")
    @Transactional
    @Operation(summary = "Elimina un paciente a partir del ID - pasa a estado inactivo")
    ...
    @PutMapping("/{id}")
    @Transactional
    @Operation(summary = "Activa un paciente registrado a partir del ID - pasa a estado activo")
